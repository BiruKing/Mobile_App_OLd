...
public final class ProfileBinding implements ViewBinding {
  ...
  private ProfileBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView2,
  ...
  public static ProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProfileBinding((ConstraintLayout) rootView, imageView2, penality, report,
